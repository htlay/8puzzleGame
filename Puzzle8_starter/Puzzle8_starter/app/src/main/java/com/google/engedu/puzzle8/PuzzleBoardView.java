...
public class PuzzleBoardView extends View {
    ...
    public void solve(){
        ...
        while (!priorityQueue.isEmpty()){
            PuzzleBoard bestTile = priorityQueue.poll();
            if(bestTile.resolved()){
                ArrayList<PuzzleBoard> solutions = new ArrayList<>();
                while (bestTile.getPreviousBoard() != null){
                    solutions.add(bestTile);
                    bestTile = bestTile.getPreviousBoard();
                }
                ...
                priorityQueue.addAll(bestTile.neighbours());
            }
        }
    }
}
